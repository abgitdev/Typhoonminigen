...
![Typhoonminigen — Generate view with live telemetry](docs/screenshots/generate.jpg)

*Type a prompt in any language, press Generate, and watch live system telemetry while Klein renders fully on-device.*
...
understands **prompts in any language natively** — no translation needed.
...
**Gallery — every render is kept with its full recipe; browse and re-use any of them.**

![Gallery](docs/screenshots/gallery.jpg)

**Library — curated, ready-to-use scene presets across 15 categories.** One tap loads a complete scene into Generate; edit the subject and press Generate.
...
![Recipe & Remix](docs/screenshots/recipe.jpg)
